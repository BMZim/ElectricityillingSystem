 ...
 * @author Zim
 */
public class ForgotPassAdmin extends javax.swing.JFrame {

    
int positionX = 0, positionY=0;


    public ForgotPassAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 130, 40));
        ...
        jobid.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(jobid, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 205, 36));
        ...
        jPanel1.add(ans, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 200, 39));
        ...
        jPanel1.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 200, 33));
        ...
        jPanel1.add(disable, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, 33));
        ...
        jPanel1.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, 33));

        ques.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jPanel1.add(ques, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 250, 40));
        ...
        jPanel1.add(checkbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 250, 20));
    ...
    private void changeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeActionPerformed
        ...
        try{
            ...
            String query = "select * from adminlogin where jobid= '"+sjobid+"'";
             ResultSet rs = c.s.executeQuery(query);
             if(sjobid.equals("") || sques.equals("") || spass.equals("")){
                 
                 JOptionPane.showMessageDialog(null, " All Fields Are Required!!");
                 
             }else if (rs.next()){
                
                 String query1 = "select * from adminlogin where jobid= '"+sjobid+"' and Security_Question = '"+sques+"' and answer = '"+sans+"'";
             ResultSet ra = c.s.executeQuery(query1);
             
             if(ra.next()){
                 String query2 = "update adminlogin set PASSWORD = '"+spass+"' where Security_Question = '"+sques+"' and jobid = '"+sjobid+"'";
    ...
    private void checkboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkboxActionPerformed
        ...
        try{
            ...
            if (rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "This Jobid Doesn't Exists");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForgotPassAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
